export const dummy = [
  `미국 대통령 선거 결과 민주당 조 바이든 후보의 당선이 유력하다. 미 언론들에 따르면 5일 오전(현지시간) 현재 바이든은 264명의 선거인단 대의원을 확보, 당선에 필요한 270명을 채우는 데는 문제가 없을 것으로 예상됐다. 이로써 지난 4년간 세계를 곤혹스럽게 한 도널드 트럼프 대통령의 일방적인 국정 운영은 퇴장하게 됐다. 바이든은 선거 과정에서 트럼프의 미국 우선주의, 반세계화, 보호무역, 반이민 등과 결별하고 자유주의 국제질서 회복에 나서겠다고 공약했다. 국제사회의 희망대로 바이든이 미국을 정상화하기를 기대한다. <br/> 바이든 후보의 첫 번째 과제는 트럼프 대외정책의 전환이다. 핵심은 ‘미국 우선주의’를 종식시키는 것이다. 바이든과 민주당은 트럼프가 훼손한 동맹관계를 재건해 미국의 영향력을 강화하는 방향의 다자주의를 강조한 바 있다. 세계보건기구(WHO), 유엔 인권위원회, 파리기후변화협정 등 트럼프가 탈퇴한 국제기구와 협정 복귀도 천명했다. 바이든은 지난 4일 “취임 전까지 파리협정에 다시 가입하겠다”고 밝혔다. 파리협정 재가입은 기후변화 및 환경 중시 정책을 펼치겠다는 메시지이다. 트럼프 정부의 과오를 되돌린다는 점에서 다행스럽다. 바이든은 2050년까지 100% 청정에너지 전환과 온실가스 감축 목표를 높이는 등 기후변화 및 환경 정책에 큰 변화를 예고했다. 지구촌 최대 과제인 환경 문제 해결에 지도국가로서 앞장서야 한다. <br/> 경제·통상 정책에서는 보호무역주의 장벽을 낮추는 것이 과제다. 물론 바이든 시대에도 자국 우선주의 기조는 크게 달라지지 않아 보호무역주의가 지속될 가능성이 없지 않다. 하지만 무역자유·개방경제를 강화하겠다는 약속은 지켜야 한다. “중국에 대한 접근은 미국의 국익에 따를 것”이라고 밝혀 대중 강경 노선은 그대로 유지될 것으로 전망된다. <br/> 바이든은 그동안 주한미군 철수와 과도한 방위비를 부담시키는 것에 반대하는 입장을 보였다. 방위비분담금 협상 등에서 한·미동맹을 존중하겠다는 약속에 기대를 건다. 특히 방위비분담금 협상을 주한미군 철수와 연계하지 않겠다는 약속은 반드시 지켜야 한다. 대북정책, 특히 북한의 비핵화 협상은 재조정이 불가피해 보인다. 바이든은 그동안 여러 차례 트럼프의 톱다운 방식을 폐기하고 실무협상을 통한 원칙적 접근을 강조했다. 하지만 이런 변화가 북핵 문제 해결을 뒤로 미루는 데로 이어져서는 안 된다. 버락 오바마 행정부의 2인자였던 바이든 후보가 당시처럼 ‘전략적 인내’ 정책으로 후퇴해서는 안 된다는 말이다. 그때와 달리 북한이 핵을 보유하고 미 본토까지 도달할 수 있는 기술을 보유하고 있음을 인정해야 한다. 우려스러운 것은 미·중 갈등에 따른 압박이다. 바이든은 동맹과 유대 강화를 통해 중국을 견제한다는 전략을 세워놓고 있다. 대중 포위망에 한국을 편입시키려고 해서는 안 된다. <br/> 청와대는 5일 국가안전보장회의(NSC) 상임위원회를 열어 “한·미동맹을 바탕으로 한반도 평화프로세스 진전을 위한 노력에 빈틈이 없도록 하겠다”고 밝혔다. 대선 국면이 정리되지 않은 미국의 불확실성에 적절히 대응하면서 새 정부와 협력을 모색해야 한다. 트럼프 때와 다르게 남북관계 진전과 한·미동맹의 균형을 맞추는 데도 더욱 유의할 필요가 있다.`,
];
...
<br/> <br/> 이 기술이 가장 집약적으로 사용된 곳이 중국 북서부 신장위구르자치구다. 소수민족 위구르인 100만명을 ‘재교육 캠프’에 강제수용한 것으로 알려져 논란이 된 이곳에서, 공안은 시장, 학교, 모스크 등 일상생활의 전 영역에 감시카메라와 데이터처리 장비, 클라우드 저장 장치, 드론 감시 시스템을 설치해 주민들의 일거수일투족을 감시한다. 중국 당국이 신장의 감시 시스템에 투자하는 막대한 예산은 관련 기업으로 흘러들어가 이들 기업을 급성장시키고 기술을 더욱 업그레이드한다.
<br/> <br/> 2019년 10월8일 미국 상무부는 신장에서 위구르인들에 대한 인권 탄압에 관여했다는 이유로 메그비, 센스타임, 화웨이 등 8개 기업을 블랙리스트에 올려, 미 상무부의 승인 없이는 반도체칩 등 미국 첨단기술 부품을 살 수 없도록 했다. 하지만 이들 기업은 계속해서 투자를 끌어들이며 여전히 승승장구하고 있다.
<br/> <br/> 이제 32살이 된 인치는 중국의 스타 기업인이다. 그는 2019년 홍콩 <사우스차이나 모닝포스트> 인터뷰에서 “알고리즘은 아름답고 명료하고 우아한 것”이라고 말했다. 신장에서 인권 탄압에 그 기술이 사용된다는 비판에 대해서는 “기술은 결코 잘못이 없으며, 책임은 사람이 져야 한다”고만 답했다.
<br/> <br/> ‘4차 산업혁명’으로 각광받는 안면·음성인식, 인공지능, 빅데이터 기술은 ‘감시 자본주의’의 핵심이다. 실은 ‘감시 자본주의’가 중국에만 존재하는 것이 아니다. 구글, 페이스북, 인스타그램, 네이버, 카카오톡, 틱톡 등 수많은 첨단 정보기술 기업들이 ‘무료로’ 서비스를 제공하지만, 실제로는 사용자들의 개인정보를 추출해, 개인들의 성향과 행동, 특징을 파악하고 상품화해 거액을 벌어들인다.
<br/> <br/> 이 미래산업에서 중국 기업들은 미국이나 다른 ‘선진국’ 기업들을 제치고 선두 주자로 대약진했다. 우선 14억 인구에서 나오는 빅데이터를 기업과 정부가 제한 없이 활용하기 때문이다. 혼란을 두려워하고 안정을 원하는 인민이 감시 시스템이 등장한 뒤 범죄가 줄고, 생활이 편리해지는 것을 반기는 측면도 분명 존재한다. 중국 당국은 범죄와 테러, 재난의 위험으로부터 시민들을 보호한다는 명분으로 세계에서 가장 강력한 감시망을 구축했고 이를 통해 수집되는 방대한 데이터는 중국의 인공지능 관련 산업에 다른 나라 기업들은 상상하기 힘든 유리한 환경을 조성했다. 당국은 주민들의 얼굴을 여러 각도에서 촬영하고 지문, 홍채 정보까지 등록시키고 있다. ‘중국제조 2025’ 정책을 통해 중국 정부가 대규모 자금을 이들 미래산업에 전략적으로 투입해 전폭 지원한 것도 이들 기업이 세계 최강으로 급성장한 동력이 되었다.
<br/> <br/> 감시카메라, 안면·홍채인식 등 바이오 감시 기술과 관련해 2017년 한 해 동안 중국 기업은 530건의 특허를 출원해 미국의 96건을 월등히 앞섰다. 국외에서 퉁팡이라는 중국 기업의 이름을 들어본 사람은 드물지만, 이 회사의 자회사인 ‘눅텍’(Nuctech)는 100개국 이상의 공항과 국경의 보안 검색 장비를 판매했다. 하이크비전은 2010년에는 매출 기준 세계 10위의 감시카메라 제조업체였지만 2016년에서는 1위 업체가 됐다. 2018년 세계 20대 감시카메라 업체 가운데 6개가 중국 기업이다.
<br/> <br/> 14억 인민을 상대로 모이는 방대한 데이터를 처리하는 클라우드 컴퓨팅, 저장, 인공지능 분석이 핵심 기술이다. 더 철저히 감시하면 더 많은 빅데이터가 모이고, 기술과 사업은 더 급속도로 성장한다. 감시와 산업, 돈이 하나로 얽힌 ‘위대한 신세계’다. 2019년 저장성 항저우시의 한 고등학교에서는 안면인식 기술을 활용해 학생 개개인의 표정을 분석해 얼마나 수업에 집중하는지를 감시하고 있다는 보도가 나와 논란이 일기도 했다. 많은 공장에선 노동자들의 표정과 동작, 작업량을 실시간으로 분석해 얼마나 열심히 근무하는지를 감시한다.
<br/> <br/> 시민이 견제·감시할 힘이 없는 중국에서 ‘4차 산업혁명’은 이처럼 ‘감시 자본주의’의 본질을 더욱 뚜렷이 드러내는 동안 기술은 더욱 급속하게 발전한다. 당은, 기업은, 권력, 질서는 언제 어디서나 당신의 일거수일투족을 파악하고 있다. 중국 당국은 한 단계 더 나아가 ‘사회신용시스템’(社會信用體系)을 구축하고 있다. 2018년부터 여러 도시에서 시범 실시 중인 이 시스템은 개개인의 일상 행동에 점수를 매겨 혜택 또는 처벌을 하는 개념이다. 교통법규 위반은 감점, 은행 신용도가 높으면 점수가 올라가는 식이다. 사회신용점수 총점이 높은 사람은 은행에서 낮은 이자로 쉽게 돈을 빌리고, 점수가 낮으면 취업이나 대학 입시에서 감점을 당하거나, 비행기나 기차표를 살 수 없게 된다. 실제로 국가발전개혁위원회는 2019년 6월 발표한 통계에서 사회신용점수가 낮은 이들에게 2682만장의 비행기 티켓과 596만장의 고속열차표 구매가 거부되었다고 밝혔다. 이 시스템이 전면 도입되면, 스마트폰, 감시카메라, 디지털 화폐 사용 정보를 결합해, 14억 인민의 모든 행동과 이동, 소비, 금융, 의료 정보를 파악해 개개인의 신용을 점수화할 수 있게 된다. 이론적으로는 국가가 한 사람의 이동 기록, 친구 관계, 지인, 책과 글, 자료를 읽는 습관 등을 근거로 반정부 활동에 나설 가능성을 ‘사전에’ 예측해 제재에 나설 수 있다는 전망까지 나온다.
<br/> <br/> 최첨단 인공지능 기술을 활용한 역사상 가장 강력한 감시 시스템은 중앙권력이 ‘백성’ 개개인을 완벽하게 통제하려는 진시황의 이상을 현실로 구현하는 듯하다. 2014년 전국인민대표대회 60주년 기념행사에서 시진핑 주석은 “법을 받드는 이가 강하면 국가가 강해지고, 법을 받드는 이가 약하면 나라가 약해진다”고 했다. 모든 권력자들이 꿈꿨던 법가적 빅브러더 사회가 21세기 첨단기술로 실현되고 있다.`,
];

export const avengers = [
  `6개의 인피니티 스톤으로 풀어보는 <어벤져스: 인피니티 워> <br/>
드디어 끝, 그러나 어김없이 다시 시작할 MCU <br/>
<br/>
<br/>
...
export const news2 = [
  `코로나 시대 온라인여행
<br/> <br/>
에어부산은 착륙하지 않고 정해진 노선을 운항하는 ‘체험비행’ 상품을 선보였다.
<br/> <br/>
...
여행지를 뜯고, 맛보고, 즐기고
<br/> <br/>
‘비대면 여행’의 가장 손쉬운 방법은 과거 여행에 대한 ‘추억체험’이다. 그간의 여행 사진과 영상을 꺼내 보며 추억하는 것은 물론, 3차원(3D) 지도인 ‘구글 어스’로 방문했던 여행지를 찾아가는 방법이 있다. 미국 뉴욕, 일본 도쿄 등 세계의 대표 도시들을 실제 거니는 듯한 시점으로 영상을 감상할 수 있는 유튜브 채널 ‘노마딕 앰비언스’(Normadic Ambience)가 인기다. 여행사들은 발 빠르게 이런 욕구를 겨냥한 상품을 내놓고 있다. 마이리얼트립, 해피칼리지 등 여행 플랫폼이 출시한 ‘가이드와 함께하는 랜선 투어’가 대표적이다. 실시간 스트리밍(재생)으로 가이드와 참여자가 서로 의사소통하며 여행하는 상품도 있다. 중국 유튜브 채널 타오바오는 ‘타오바오 라이브’를 통해 5세대(5G) 기술을 활용한 고품질 영상으로 티베트 달라이라마 궁전의 옥기, 자기, 용포 등 건축물의 세세한 표현을 카메라에 담는 방식의 콘텐츠를 개발했다. 현재까지 타오바오 라이브에 가입한 관광지는 칭다오 삼림 야생동물원 등 1천 곳이 넘는 것으로 알려졌다.공유숙박 플랫폼 에어비앤비는 메인 홈페이지에 여행 특가 상품 대신 현지인에게 배우는 요리, 스리랑카 사파리 체험 등 관광을 넘어 각국의 생활방식을 체험하는 프로그램을 마련했다.
<br/> <br/>
전세계를 ‘지금, 여기’로
<br/> <br/>
여행지를 관광하기보다 세계의 ‘지금, 여기’를 날것으로 감상할 수 있는 ‘중계’ 콘텐츠도 인기다. 세계 곳곳의 주민이 자신들의 집 창밖 풍경을 공유하는 사이트 ‘윈도 스와프’(Window Swap)가 대표적이다. 다른 나라의 주민 입장이 되어 그 동네의 이국적인 풍경, 그곳 언어와 동물 소리 등 생활 소음까지 경험할 수 있는 점이 매력 포인트다. 미국 뉴욕 타임스스퀘어를 비추는 유튜브 ‘어스캠’(Earthcam) 채널의 실시간 중계 영상도 있다. 타임스스퀘어를 고정 화면으로 송출하는 영상은 지루할 것이라는 예상과 달리, 각종 영화와 드라마에서 항상 사람이 붐비는 장소로 나왔던 거리가 한산한 것만으로도 볼거리가 된다. 각국 관광청 누리집을 접속하는 것도 좋은 방법이다. 360도로 펼쳐지는 프랑스 파리의 파노라믹뷰를 감상할 수 있는 프랑스 관광청의 랜선 투어가 그렇다. 핀란드 관광청은 핀란드 현지인에게서 행복 노하우를 배운다는 콘셉트의 ‘렌트 어 핀(Rent a Finn) 캠페인’을 진행했다. 국내에서도 ‘남산서울타워’와 ‘에버랜드 라이브’ 채널이 운영 중이다. 유튜브에서 ‘world live camera’라는 단어를 검색하면 중계 콘텐츠가 수두룩해, 자기 취향에 맞게 골라 볼 수 있다.
<br/> <br/>
여행의 설렘, 공항에서부터
<br/> <br/>
‘무알코올 맥주’는 약 복용이나 건강상의 이유로 술을 마시지 못할 때 괜찮은 대안이다. 알코올을 섭취하지 않아도 실제 맥주 용기와 비슷한 디자인과 맛 등을 통해 ‘취한 기분’을 낼 수 있기 때문이다. 이처럼 ‘여행 분위기’에 초점을 맞춰 즐기는 콘텐츠도 있다. 공항 대기실의 웅성거림, 비행기 이착륙 소리 등을 듣는 ‘공항 ASMR’(Autonomous Sensory Meridian Response, ‘자율감각쾌락반응’으로 보통 일상 소음을 재현한 것), 공항 탑승 수속부터 이륙, 비행, 착륙 등의 과정을 체험하는 ‘공항 롤플레이’가 유명하다. 또 친구와 침대에 함께 엎드려 두런두런 이야기를 나누며 여행 계획을 세우거나 여행 메이크업을 해주는 ‘여행 상황극 ASMR’도 나와 있다. 심지어 여권 내지부터 여권 케이스 등의 표면을 ‘태핑’하는(두드리는) ‘여권 ASMR’까지 등장했다. 이 정도면 여행을 구성하는 요소는 거의 다 불러들인 것 같다. 항공업계에서는 ‘목적지에 착륙하지 않는 목적’의 ‘체험 비행’ 상품을 잇달아 출시하고 있다. 국내 항공사에선 에어부산이 처음 특정 지역에 착륙하지 않고 정해진 노선을 운항하는 체험 비행을 선보인다. 승객 처지에선 체험 비행으로 탑승 경험뿐 아니라 기내식과 기내 엔터테인먼트를 즐길 수 있다. 기내 면세품도 살 수 있어 ‘여행 기분’을 충분히 즐길 수 있다. 중국의 중화항공은 어린이가 승무원 출국 체험을 할 수 있는 비행 상품을 내놓았다.항공사는 아니지만, 일본 가상현실(VR) 업체 ‘퍼스트 에어라인’도 VR로 ‘체험 비행’을 제공한다. 실제 기내를 본뜬 체험 부스에는 기내식, 기내 엔터테인먼트 등 서비스도 마련돼 있다. 목적지 도착을 알리는 안내방송이 나오면 VR 헤드셋을 쓰고 하와이 등의 관광지를 가상 여행하는 식이다.
<br/> <br/>
데꾸테리어, 방구석 여행하기
<br/> <br/>
...
시간 여행하기
<br/> <br/>
공간뿐 아니라 시간을 여행하는 콘텐츠도 나왔다. 20세기 프랑스, 독일의 거리를 찍은 흑백 영상을 색채 복원 기술로 재현한 유튜버 데니스 시르예프의 콘텐츠는 원본 영상보다 더 높은 조회수를 기록하고 있다. 유튜브에 ‘인공지능 채색’으로 검색하면 우리나라 유튜버가 비슷한 콘셉트로 근대 도심을 복원한 영상도 감상할 수 있다. 이외에 ‘랜선 여행’을 주제로 한 노래(폴킴의 <집돌이>, 레인메이커의 <랜선 여행>), ‘여행 노래 모음’을 들으며 음악으로 여행을 감각하기도 한다. 하늘길이 막히니 다른 길이 열렸다. 서울에서 부산까지 자전거, 버스, 택시 등 대중교통만으로 이동하며 ‘여행 경로’를 다르게 체험하고 후기를 공유하는 콘텐츠도 쉽게 찾아볼 수 있다.여행의 뉴노멀 상상하기온라인 여행은 랜선만 연결된다면 갈 수 있기에 저렴하고 친환경적인 면이 크다. 랜선 여행에서 나아가, 여행의 뉴노멀(새 표준)을 근본적으로 상상하는 논의도 이뤄지고 있다. 먼저 지금 코로나 시국이 무분별한 환경파괴로 이어진 사태라는 점에서 과거의 ‘저탄소 녹색관광, 생태관광’ 등 대안 관광 담론이 다시 떠오른다. 개인 차원에선 비행기 탑승 거부를 선언하는 유명인이 나타나고 있다. 환경운동가 그레타 툰베리가 유엔 기후행동 정상회의에 참석하기 위해 탄소를 배출하지 않는 배를 타고 영국에서 미국으로 간 사례가 그렇다. 스웨덴에서는 비행기 여행의 부끄러움 ‘플라이트 셰임’(Flight Shame)을 뜻하는 ‘플뤼그스캄’(flygskam) 운동이 일기도 했다. 탄소배출량 감소를 위해 비행기 대신 기차 등의 교통수단을 장려하는 움직임이었다. 국제민간항공기구(ICAO)는 국제항공 운송 부문의 탄소배출 동결을 목표로 하는 ‘국제항공 탄소상쇄·감축제도’(CORSIA) 이행을 결의하기도 했고, ‘항공환경세’ 도입을 검토하는 국가도 늘고 있다. 호텔업계에서도 재생에너지 발전, 친환경 제품을 쓰며 ‘에코 호텔’을 표방하는 사례가 생기고 있다.젠더 관점으로 새로운 도시여행을 기획한 경우도 있다. 한국양성평등교육진흥원에서 제작한 도시여행 가이드북 <2020 젠더, 도시를 만나다>(Gender+City Travel)는 지속가능한 미래를 모색하는 여성과 공동체를 소개했다(문의 02-3156-6133). 재난이 모두에게 평등하지 않듯이, 여행도 항상 평등하지 않았다. 우리는 머물 곳을 전전하는 노숙인을 두고 ‘여행’한다고 하지 않는다. 여행하려면 일상으로 돌아올 수 있는 정주의 공간이 전제돼야 하기 때문이다. 방구석 여행도 활동하기엔 비좁은 원룸이나 고시원에 사는 이들에게는 ‘먼 나라’ 이야기일 뿐이다. 기존에도 이동권이 충분히 보장되지 않았던 장애인이나 험지로 나 홀로 여행을 꿈꾸기 어려웠던 여성 등은 코로나 시국 이전의 여행이 그립지 않을지도 모른다.우리가 여행을 사랑하는 이유로 ‘예측 불가능성’을 꼽는다. ‘코로나 시대’라는 낯선 시공간에 도착한 지금, 다른 차원의 여행을 상상하고 꾸리는 일 역시 여정의 일부이지 않을까. 우리는 늘 그렇듯이 길을 찾아낼 것이다.`,
];
